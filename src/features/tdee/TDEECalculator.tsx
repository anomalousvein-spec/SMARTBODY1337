    ...
    <div className="glass card-hover rounded-2xl p-6 shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4" noValidate>
        ...
        <SelectField
          ...
          value={activityLevel}
          onChange={(val) => setActivityLevel(val as TDEESettings['activityLevel'])}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <InputField
            label="Target Loss Rate (lbs/week)"
            type="number"
            value={targetLossRate}
            onChange={setTargetLossRate}
            step="0.1"
            min="0.1"
            max="2.5"
            placeholder="1"
        ...
        {success && <FormMessage type="success" message="Profile updated and TDEE calculated!" />}

        <SubmitButton
          isSubmitting={isSaving}
          idleText={hasSettings ? 'Update Profile' : 'Calculate TDEE'}
        />
