...
export function StandardResultsView({ bmr, tdee, cuttingCalories, currentPhase }: StandardResultsViewProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <div className="bg-theme-bg-tertiary/40 border border-white/5 rounded-xl p-4">
        ...
        <p className="text-2xl font-bold text-theme-accent">{Math.round(bmr)} <span className="text-xs font-normal text-theme-text-tertiary uppercase">cal/day</span></p>
      </div>
