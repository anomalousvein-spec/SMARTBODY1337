      ...
      <div className="mt-6 space-y-2">
        ...
        <div className="max-h-48 overflow-y-auto space-y-2 pr-1 custom-scrollbar">
          {waistEntries.slice(-10).reverse().map((entry: WaistEntry) => (
            <div key={entry.id} className="flex items-center justify-between p-3 rounded-xl bg-theme-bg-tertiary/40 border border-white/5 hover:bg-theme-bg-tertiary/60 transition-all duration-200 group">
