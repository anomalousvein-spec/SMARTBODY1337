...
export const RecommendationCard = React.memo(({ recommendation, onDismiss }: RecommendationCardProps) => {
  ...
  return (
    <div className={`${style.bg} border-l-4 ${style.border} rounded-lg p-4 mb-3`}>
